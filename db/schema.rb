...
ActiveRecord::Schema[7.0].define(version: 20_230_727_070_504) do
  ...
  create_table 'bookings', force: :cascade do |t|
    ...
    t.index %w[traveller_type traveller_id], name: 'index_bookings_on_traveller'
  end
  ...
  create_table 'hotels', force: :cascade do |t|
    ...
    t.index %w[partner_type partner_id], name: 'index_hotels_on_partner'
  end
  ...
  create_table 'tours', force: :cascade do |t|
    ...
    t.index %w[organizer_type organizer_id], name: 'index_tours_on_organizer'
  end
